  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Editorial Success Circle Badge */}
        <div style={{ width: "90px", height: "90px", margin: "0 auto 1.75rem", animation: "scaleIn 0.5s cubic-bezier(0.16, 1, 0.3, 1) forwards" }}>
          <svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: "100%", height: "100%" }}>
            <circle cx="60" cy="60" r="54" fill="rgba(201, 168, 76, 0.05)" stroke={goldColor} strokeWidth="3"/>
            <polyline
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
          {isApplication ? (
            ...
            <>
              <a href="https://wa.me/2349043371380" target="_blank" rel="noopener noreferrer" className="sm-btn-secondary">
                Chat on WhatsApp
              </a>
              <button onClick={onClose} className="sm-btn-outline">
                Dismiss Panel
        ...
        <p style={{ fontSize: "0.65rem", fontFamily: "monospace", textTransform: "uppercase", letterSpacing: "0.05em", color: "#9ca3af", marginTop: "1.5rem", marginBottom: 0 }}>
