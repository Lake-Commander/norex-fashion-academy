...
// Helper to get products by gender
export function getProductsByGender(gender: "Male" | "Female" | "Both"): Product[] {
  return products.filter(
    (p) => p.gender === gender || p.gender === "Both"
  );
}